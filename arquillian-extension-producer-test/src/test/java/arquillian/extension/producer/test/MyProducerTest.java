...
/**
 * Tests the correctness of injection into test class
 *
...
public class MyProducerTest {
    ...
    public void injectFieldsTest() {
        ...
        // should be injected an instance for field from the ProviderProducer class - the default one
        ...
        // should be injected an instance for field from the ProviderProducer class - the specific one
    ...
    public void injectParamsTest(
        ...
        // should be injected an instance for method parameter from the ProviderProducer class - the default one
        ...
        // should be injected an instance for method parameter from the ProviderProducer class - the specific one
        Assert.assertNotNull(providedParam);
